...
//        write a program that print your name with a greeting - Welcome, YOUR_NAME_Here!
//        String name = "Knoah Cotto";
...
//            System.out.printf("Hello %n%S", bigBall); // all caps and the %n for new line

        // multiple variables:
//            int three = 3;
//            String typeOfPetGroup = "cats";
//            System.out.printf("I have %d %s.", three, typeOfPetGroup); //d for decimal f for float
...
//        String userInput = sc.nextLine(); // or use .next
